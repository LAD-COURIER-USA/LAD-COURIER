...
def main():
    ...
    tasks = [
        {'name': 'Massachusetts', 'file': 'geodata-MA-final.csv', 'coll': 'geodata_us_ma', 'code': 'MA'},
        {'name': 'Maryland', 'file': 'geodata-MD-final.csv', 'coll': 'geodata_us_md', 'code': 'MD'},
        {'name': 'Maine', 'file': 'geodata-ME-final.csv', 'coll': 'geodata_us_me', 'code': 'ME'},
        {'name': 'Michigan', 'file': 'geodata-MI-final.csv', 'coll': 'geodata_us_mi', 'code': 'MI'},
    ]
