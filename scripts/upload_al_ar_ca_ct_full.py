...
def main():
    ...
    tasks = [
        {'name': 'Alabama', 'file': 'geodata-AL-final.csv', 'coll': 'geodata_us_al', 'code': 'AL'},
        {'name': 'Arkansas', 'file': 'geodata-AR-final.csv', 'coll': 'geodata_us_ar', 'code': 'AR'},
        {'name': 'California', 'file': 'geodata-CA-final.csv', 'coll': 'geodata_us_ca', 'code': 'CA'},
        {'name': 'Connecticut', 'file': 'geodata-CT-final.csv', 'coll': 'geodata_us_ct', 'code': 'CT'},
    ]
