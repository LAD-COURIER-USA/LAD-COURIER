...
def main():
    ...
    tasks = [
        {'name': 'Nebraska', 'file': 'geodata-NE-final.csv', 'coll': 'geodata_us_ne', 'code': 'NE'},
        {'name': 'New Hampshire', 'file': 'geodata-NH-final.csv', 'coll': 'geodata_us_nh', 'code': 'NH'},
        {'name': 'New Jersey', 'file': 'geodata-NJ-final.csv', 'coll': 'geodata_us_nj', 'code': 'NJ'},
        {'name': 'New Mexico', 'file': 'geodata-NM-final.csv', 'coll': 'geodata_us_nm', 'code': 'NM'},
    ]
