...
def main():
    ...
    tasks = [
        {'name': 'Iowa', 'file': 'geodata-IA-final.csv', 'coll': 'geodata_us_ia', 'code': 'IA'},
        {'name': 'Kansas', 'file': 'geodata-KS-final.csv', 'coll': 'geodata_us_ks', 'code': 'KS'},
        {'name': 'Kentucky', 'file': 'geodata-KY-final.csv', 'coll': 'geodata_us_ky', 'code': 'KY'},
        {'name': 'Louisiana', 'file': 'geodata-LA-final.csv', 'coll': 'geodata_us_la', 'code': 'LA'},
    ]
