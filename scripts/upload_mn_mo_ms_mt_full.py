...
def main():
    ...
    tasks = [
        {'name': 'Minnesota', 'file': 'geodata-MN-final.csv', 'coll': 'geodata_us_mn', 'code': 'MN'},
        {'name': 'Missouri', 'file': 'geodata-MO-final.csv', 'coll': 'geodata_us_mo', 'code': 'MO'},
        {'name': 'Mississippi', 'file': 'geodata-MS-final.csv', 'coll': 'geodata_us_ms', 'code': 'MS'},
        {'name': 'Montana', 'file': 'geodata-MT-final.csv', 'coll': 'geodata_us_mt', 'code': 'MT'},
    ]
