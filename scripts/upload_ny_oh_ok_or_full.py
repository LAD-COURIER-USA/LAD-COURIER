...
def main():
    ...
    tasks = [
        {'name': 'New York', 'file': 'geodata-NY-final.csv', 'coll': 'geodata_us_ny', 'code': 'NY'},
        {'name': 'Ohio', 'file': 'geodata-OH-final.csv', 'coll': 'geodata_us_oh', 'code': 'OH'},
        {'name': 'Oklahoma', 'file': 'geodata-OK-final.csv', 'coll': 'geodata_us_ok', 'code': 'OK'},
        {'name': 'Oregon', 'file': 'geodata-OR-final.csv', 'coll': 'geodata_us_or', 'code': 'OR'},
    ]
