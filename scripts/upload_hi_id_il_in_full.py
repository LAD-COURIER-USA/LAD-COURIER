...
def main():
    ...
    tasks = [
        {'name': 'Hawaii', 'file': 'geodata-HI-final.csv', 'coll': 'geodata_us_hi', 'code': 'HI'},
        {'name': 'Idaho', 'file': 'geodata-ID-final.csv', 'coll': 'geodata_us_id', 'code': 'ID'},
        {'name': 'Illinois', 'file': 'geodata-IL-final.csv', 'coll': 'geodata_us_il', 'code': 'IL'},
        {'name': 'Indiana', 'file': 'geodata-IN-final.csv', 'coll': 'geodata_us_in', 'code': 'IN'},
    ]
