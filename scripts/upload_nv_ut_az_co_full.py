...
def main():
    ...
    # Definición de los 4 nuevos estados
    tasks = [
        {'name': 'Nevada', 'file': 'geodata-NV-final.csv', 'coll': 'geodata_us_nv', 'code': 'NV'},
        {'name': 'Utah', 'file': 'geodata-UT-final.csv', 'coll': 'geodata_us_ut', 'code': 'UT'},
        {'name': 'Arizona', 'file': 'geodata-AZ-final.csv', 'coll': 'geodata_us_az', 'code': 'AZ'},
        {'name': 'Colorado', 'file': 'geodata-CO-final.csv', 'coll': 'geodata_us_co', 'code': 'CO'},
    ]
