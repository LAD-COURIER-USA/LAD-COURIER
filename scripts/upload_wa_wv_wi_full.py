...
def main():
    ...
    tasks = [
        {'name': 'Washington', 'file': 'geodata-WA-final.csv', 'coll': 'geodata_us_wa', 'code': 'WA'},
        {'name': 'West Virginia', 'file': 'geodata-WV-final.csv', 'coll': 'geodata_us_wv', 'code': 'WV'},
        {'name': 'Wisconsin', 'file': 'geodata-WI-final.csv', 'coll': 'geodata_us_wi', 'code': 'WI'},
    ]
