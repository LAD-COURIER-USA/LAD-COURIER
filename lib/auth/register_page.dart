...
class _RegisterPageState extends State<RegisterPage> {
  ...
  bool _isRegistering = false; // 🛡️ SISTEMA LAD: Estado local en lugar de Diálogo
  ...
  void signUp(AppLocalizations l10n) async {
    ...
    try {
      ...
      if (result == 'SUCCESS') {
        // Al tener éxito, AuthGate detectará al usuario y cambiará la pantalla.
        // Al ser un estado local, el spinner desaparecerá automáticamente al desmontar el widget.
      } else {
        if (mounted) {
